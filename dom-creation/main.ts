...
function renderPokemon(pokemon: Pokemon): HTMLDivElement {
  ...
  textDiv.append(nameElement, numberElement, descriptionElement);
  cardDiv.append(imgElement, textDiv);
  columnDiv.appendChild(cardDiv);

  return columnDiv;
}
console.log(renderPokemon); // temporary code
console.log();
...
const xd = pokedex; // temporary code
console.log(xd); //  temporary code
